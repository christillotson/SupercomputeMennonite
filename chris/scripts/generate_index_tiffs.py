...
def process(scene_dir: str, output_dir: str) -> None:
...
if __name__ == "__main__":
    ...
    output_directory = sys.argv[2] if len(sys.argv) >= 3 else os.path.join(scene_directory, "indices")

    process(scene_directory, output_directory)
